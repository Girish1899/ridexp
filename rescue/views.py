...
from superadmin.models import Brand, Category, Customer, CustomerHistory, DriverHistory, Model, Profile,RideDetails,Driver, RideDetailsHistory, Ridetype, Vehicle,User
...
@login_required
def rescue_profile_view(request):
    profile = get_object_or_404(Profile, user=request.user, type='rescue')
