...
class RidePricing(models.Model):
    # Local price ##################33333
    PRICE_TYPE_CHOICES = [
    ...
    ride_pricing_id = models.AutoField(primary_key=True)
    city = models.CharField(max_length=100, null=True)  
    car_category = models.ForeignKey(Model, on_delete=models.CASCADE, null=True)
    price_type = models.CharField(max_length=25, choices=PRICE_TYPE_CHOICES, null=True)  
    company_commission = models.DecimalField(max_digits=5, decimal_places=2, null=True, default=0.00)  
    driver_commission_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, default=0.00)  
    vat_tax_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, default=0.00)  
    waiting_time_per_min_charge = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00) 
    driver_per_km_commission_type = models.CharField(max_length=25, null=True, default="No")  
    dead_per_km_charge = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00) 

    # Day Time Ride Non AC
    customer_day_base_fare_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_per_min_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_0_5_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_5_10_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_10_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_above_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    
    driver_day_base_fare_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_per_min_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_0_5_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_5_10_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_10_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_above_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Night Time Ride Non AC
    customer_night_base_fare_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_per_min_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_0_5_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_5_10_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_10_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_above_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    
    driver_night_base_fare_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_per_min_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_0_5_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_5_10_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_10_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_above_15_km_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Day Time Ride AC
    customer_day_base_fare_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_per_min_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_0_5_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_5_10_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_10_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_day_price_above_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    
    driver_day_base_fare_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_per_min_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_0_5_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_5_10_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_10_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_day_price_above_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Night Time Ride AC
    customer_night_base_fare_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_per_min_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_0_5_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_5_10_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_10_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_night_price_above_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    
    driver_night_base_fare_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_per_min_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_0_5_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_5_10_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_10_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_night_price_above_15_km_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Local Package #############################
    package_name = models.CharField(max_length=100, null=True)  
    min_amount_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    min_amount_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    max_km_per_day_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    max_km_per_day_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    extra_hr_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    extra_hr_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    extra_km_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    extra_km_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00) 
    gst_tax_percentage = models.DecimalField(max_digits=5, decimal_places=2, null=True, default=0.00) 
    driver_allowance = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00) 
    additional_info = models.CharField(max_length=1000, blank=True, null=True)  
    driver_per_km_commission_charge = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  

    # Airport #############################
    customer_min_amount_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_min_amount_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_min_amount_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_min_amount_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Customer & Driver Min km/day
    customer_min_km_day_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_min_km_day_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_min_km_day_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_min_km_day_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Customer & Driver Extra hour/km charge
    customer_extra_hour_km_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_extra_hour_km_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_extra_hour_km_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_extra_hour_km_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Customer & Driver Extra km charge
    customer_extra_km_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_extra_km_charge_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    customer_extra_km_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    driver_extra_km_charge_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)

    # Toll Charge
    toll_charge = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    ...
    trip_type = models.CharField(max_length=10, choices=TRIP_TYPE_CHOICES, null=True, default='one_way')  

    # AC
    customer_min_km_per_day_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    driver_max_km_per_day_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    # Non AC
    customer_min_km_per_day_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    driver_max_km_per_day_non_ac = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)  
    driver_night_bata = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=0.00)
    created_on = models.DateField(auto_now_add=True)
    updated_on = models.DateField(auto_now=True)
